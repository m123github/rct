...
export default class NominationEntry extends Component {
    constructor(props) {
        super(props);
...
{/* typoghraphy */}
    <Grid item spacing={16} xs={4} style={{height: "auto"}}>
        <Typography component="div" style={{ color: "#000000", fontSize: "13px",textAlign:"left",paddingTop:"3px" }}>Nomination No.</Typography>
...
<Grid container spacing={16} xs={12} style={{height: "auto"}}>
 {/* 21 row */}
 <Grid container spacing={16} xs={6} style={{height: "60px"}}>
{/* typoghraphy */}
    <Grid item spacing={16} xs={4} style={{height: "auto"}}>
        <Typography component="div" style={{ color: "#000000", fontSize: "13px",textAlign:"left",paddingTop:"3px" }}>Name<span>*</span></Typography>
    </Grid>
    {/* component */}
    <Grid item spacing={16} xs={8} style={{height: "auto"}}>
    <Input inputRef={this.housename} disableUnderline="true" style={{ backgroundColor:"white",color: "#000000", fontSize: "16px",width:"141px"/* fontWeight: "300" */ }}></Input>
        </Grid>
</Grid>
{/* 22 row */}
<Grid container spacing={16} xs={6} style={{height: "40px"}}>
 ...
 <Grid item spacing={16} xs={4} style={{height: "auto"}}>
    ...
    {/* component */}
    <Grid item spacing={16} xs={8} style={{height: "auto"}}>
    <Input inputRef={this.place} disableUnderline="true" style={{ backgroundColor:"white",color: "#000000", fontSize: "16px",width:"141px"/* fontWeight: "300" */ }}></Input>
    </Grid>
...
{/* typoghraphy */}
    ...
    {/* component */}
    <Grid item spacing={16} xs={8} style={{height: "auto"}}>
    <Input inputRef={this.distrct} disableUnderline="true" style={{ backgroundColor:"white",color: "#000000", fontSize: "16px",width:"141px"/* fontWeight: "300" */ }}></Input>
        </Grid>
</Grid>
{/* 22 row */}
<Grid container spacing={16} xs={6} style={{height: "40px"}}>
 ...
 <Grid item spacing={16} xs={4} style={{height: "auto"}}>
    ...
    <FormControl component="fieldset" >
                  ...
                  <FormGroup>
                    <FormControlLabel
                      control={
                        <Checkbox checked={this.state.minor} onChange={this.handleminor('minor')} value="minor" />
                      }
...
<Grid container spacing={16} xs={12} style={{height: "auto"}}>
<Typography component="div" style={{ color: "#000000", fontSize: "16px",textAlign:"left",paddingTop:"3px",marginBottom:"20px",marginTop:"20px",fontWeight:"bold" }}>Guardian</Typography>
</Grid>
...
{/* typoghraphy */}
    ...
    <Grid item spacing={16} xs={8} style={{height: "auto"}}>
      ...
      <Input inputRef={this.oficeNo}  disableUnderline="true" style={{ backgroundColor:"white",color: "#000000", fontSize: "16px",width:"141px"/* fontWeight: "300" */ }}></Input>
